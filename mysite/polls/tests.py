...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recenlty() returns True for questions whose pub date is
...
def create_question(question_text, days):
    ...
    positive for questions that have yet to be purchased).
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Questions with a pub_date in the future are not dislpayed on the index page
        """
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both past and future quesitons exist, onnly past questions distplayed.
        """
        question = create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
